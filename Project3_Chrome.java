...
c. Scroll to find the Popups card and click it.
d. Once the page loads, find the Sign In button on the page to open a popup with the login form.
e. Find the username and password input fields in the popup and enter the following credentials in it:
	Username: admin
	Password: password
f. Click on the Log in button to submit.
...
g. Write a test case for each scenario - One with the correct credentials and one with incorrect credentials
h. Finally, write assertions for both test cases to verify results.
*********/
...
public class Project3_Chrome {
  ...
  public void beforeClass() throws MalformedURLException {
	  ...
	  //cap.setCapability("deviceId", "V02775160360179117");
  ...
  public void mainTestInvalid() throws InterruptedException {
	  ...
	  driver.findElementByXPath("//android.view.View/android.view.View[2]/android.view.View/android.widget.EditText[2]").sendKeys("passwor");
	  driver.findElementByXPath("//android.view.View/android.view.View[2]/android.view.View/android.widget.Button").click();
	  Thread.sleep(3000);
	  String text = driver.findElementByXPath("//android.webkit.WebView/android.view.View/android.view.View[3]").getText();
